...
class Doc_address(db.Model, SerializerMixin):
    __tablename__ = 'doc_addresses'

    serialize_rules = ('-doctors',)
    ...
    def __repr__(self):
        return f'<Doctor address {self.line1}>'
...
class Doctor(db.Model, SerializerMixin):
    ...
    address = db.relationship('Doc_address', backref='doctors', lazy=True)
